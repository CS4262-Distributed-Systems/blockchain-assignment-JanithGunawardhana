...
public final class AssetTransfer implements ContractInterface {
    ...
    public String GetAllAssets(final Context ctx) {
        ...
        /**
     * Duplicate an asset in the ledger.
     *
     * @param ctx the transaction context
     * @param assetID the ID of the asset being transferred
     * @param owner the new owner
     * @return the duplicate asset(the duplicate of the new owner)
     */
    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String owner) {
        ...
        Asset duplicateAsset = new Asset(asset.getAssetID().concat("_duplicate"), asset.getColor(), asset.getSize(), owner, asset.getAppraisedValue());

        //Use Genson to convert the Asset into string, sort it alphabetically and serialize it into a json string
        String sortedJson = genson.serialize(duplicateAsset);
        stub.putStringState(duplicateAsset.getAssetID(), sortedJson);
